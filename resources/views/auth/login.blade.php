...
<head>
    ...
    <title>{{ __('Login') }} — {{ config('app.name', 'Siap Kerja') }}</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="auth-subtitle">Masuk untuk melanjutkan ke portal Anda</p>
            </div>
            ...
            <form method="POST" action="{{ route('login.post') }}">
                ...
                <div class="form-actions">
                    ...
                    @if (Route::has('password.request'))
                        <a class="forgot-password" href="{{ route('password.request') }}">Lupa sandi?</a>
                    @endif
                </div>
                ...
                <div class="social-grid">
                    <a href="{{ route('google.redirect', ['role' => 'pencari_kerja']) }}" id="google-btn" class="social-btn">
                        <img src="https://www.svgrepo.com/show/355037/google.svg" width="18" alt="Google">
                        Google
                    </a>
                    <a href="#" class="social-btn" onclick="alert('Fitur segera hadir!')">
                        <img src="https://www.svgrepo.com/show/303114/facebook-3.svg" width="18" alt="FB">
                        Facebook
                    </a>
                </div>
            </form>
    ...
    <script>
        function selectRole(role) {
            ...
            const baseUrl = "{{ route('google.redirect', ['role' => 'placeholder']) }}";
            googleBtn.href = baseUrl.replace('placeholder', role);
        }
    </script>
</body>
